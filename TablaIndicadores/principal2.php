...
<body>
   <div class="d-flex" id="content-wrapper">
        ...
        <div id="sidebar-container" class="bg-primary">
            <div class="logo">
                <h4 class="font-weight-bold mb-0">INDICADORES</h4>
            </div>
            <div class="accordion">
              <ul>
                <li class="pagenav">
                  <h4><a href="">Operaciones</a><i class="fa fa-angle-right"></i></h4>
                  <ul>
                    <li onClick="SelVta_Click()" class="page_item current_page_item"><a href="#">Ventas Netas</a></li>
                    <li onClick="SelOpc_Click()" class="page_item"><a href="#">Opciones Mostradas</a></li>
              ...
              <ul>
              <li class="pagenav">
                <h4><a href="#">Cobranza</a><i class="fa fa-angle-right"></i></h4>
                <ul>
                ...
                <ul>
                <li class="pagenav">
                  <h4><a href="#">Compras</a><i class="fa fa-angle-right"></i></h4>
                  <ul>
                          ...
                          <div class="col-lg-8 my-2">
                              <div class="card rounded-0 my-0">
                                  <div class="card-header bg-light">
                                    <h6 id = "Titulo" class="font-weight-bold mb-0 text-center">Ventas Netas</h6> 
                                    ...
                                    <form class="form-inline my-0">
                                       ...
                                       <button class="btn mb-3 width-100" Id="BtnUpdate">Actualizar</button>
